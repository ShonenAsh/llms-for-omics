...
tests/test_04_cnn.py::test_no_unused_imports PASSED                      [ 34%]
tests/test_05_attention.py::test_5a_sdpa_output_shape FAILED             [ 36%]
tests/test_05_attention.py::test_5a_weights_sum_to_one FAILED            [ 38%]
tests/test_05_attention.py::test_5b_causal_mask FAILED                   [ 39%]
tests/test_05_attention.py::test_5b_causal_output_shape FAILED           [ 41%]
tests/test_05_attention.py::test_5c_mha_output_shape FAILED              [ 42%]
...
submissions/task_03_mlp_classifier.py:28: in train_step
    optim.step()
...
self = <tinygrad.nn.optim.LAMB object at 0x7f69a9326120>
...
__________________________ test_5a_sdpa_output_shape ___________________________
...
tests/test_05_attention.py:25: 
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
submissions/task_05_attention.py:24: in scaled_dot_product_attention
    scores = Q.matmul(K.transpose(-2, -1)) / Tensor.sqrt(d_k)
                                             ^^^^^^^^^^^^^^^^
...
>     return self.cast(least_upper_float(self.dtype))._apply_uop(UOp.sqrt)
             ^^^^^^^^^
E     AttributeError: 'int' object has no attribute 'cast'

/usr/local/lib/python3.13/site-packages/tinygrad/tensor.py:2822: AttributeError
__________________________ test_5a_weights_sum_to_one __________________________
...
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
submissions/task_05_attention.py:40: in causal_attention
    scores = Q.matmul(K.transpose(-2, -1)) / Tensor.sqrt(d_k)
                                             ^^^^^^^^^^^^^^^^
/usr/local/lib/python3.13/site-packages/tinygrad/tensor.py:3991: in _wrapper
    if TRACEMETA < 1 or _METADATA.get() is not None: return fn(*args, **kwargs)
...
/usr/local/lib/python3.13/site-packages/tinygrad/tensor.py:2822: AttributeError
___________________________ test_5c_mha_output_shape ___________________________
...
tests/test_05_attention.py:69: 
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
submissions/task_05_attention.py:81: in __call__
    context_flat, _ = scaled_dot_product_attention(Q_flat, K_flat, V_flat)
                      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
submissions/task_05_attention.py:24: in scaled_dot_product_attention
    scores = Q.matmul(K.transpose(-2, -1)) / Tensor.sqrt(d_k)
                                             ^^^^^^^^^^^^^^^^
...
>       for layer in [rb.fc1, rb.fc2]:
                      ^^^^^^
E       AttributeError: 'ResidualBlock' object has no attribute 'fc1'. Did you mean: 'ff1'?
...
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
submissions/task_09_custom_losses.py:64: in contrastive_loss
    loss_dissimilar = labels * 0.5 * ((margin - d).clamp(min=0) ** 2)
                                      ^^^^^^^^^^^^^^^^^^^^^^^^^
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
unused_imports = ['dtypes', 'nn']

    def test_no_unused_imports(unused_imports):
>       assert not unused_imports, f"Unnecessary imports: {unused_imports}"
E       AssertionError: Unnecessary imports: ['dtypes', 'nn']
E       assert not ['dtypes', 'nn']
...
FAILED tests/test_05_attention.py::test_5a_sdpa_output_shape - AttributeError...
FAILED tests/test_05_attention.py::test_5a_weights_sum_to_one - AttributeErro...
FAILED tests/test_05_attention.py::test_5b_causal_mask - AttributeError: 'int...
FAILED tests/test_05_attention.py::test_5b_causal_output_shape - AttributeErr...
FAILED tests/test_05_attention.py::test_5c_mha_output_shape - AttributeError:...
...
=================== 15 failed, 48 passed in 74.31s (0:01:14) ===================
