...
submissions/task_03_mlp_classifier.py:31: in train_step
    optim.step()
...
self = <tinygrad.nn.optim.LAMB object at 0x7fcff8e02660>
...
E       AssertionError: Unnecessary imports: ['SGD']
E       assert not ['SGD']
...
E       AssertionError: focal (inf) > bce (0.7152)
E       assert array(inf, dtype=float32) <= (array(0.7151837, dtype=float32) + 0.0001)

tests/test_09_custom_losses.py:40: AssertionError
...
FAILED tests/test_09_custom_losses.py::test_9a_focal_le_bce - AssertionError:...
FAILED tests/test_10_transformer.py::test_10e_training_decreases_loss - Asser...
=================== 6 failed, 57 passed in 73.10s (0:01:13) ====================
